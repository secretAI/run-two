...
export class AuthRouter {
  ...
  private async createNewAccount(req: Request, res: Response): Promise<void> {
    const response: User = await AuthService.createNewAccount(req.body as ISignUpReq);
  ...
  private async loginIntoAccount(req: Request, res: Response): Promise<void> {
    const response: JwtTokenPair = await AuthService.loginIntoAccount(req.body as ILogInreq);
